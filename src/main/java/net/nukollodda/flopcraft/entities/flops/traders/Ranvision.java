...
public class Ranvision extends AbstractIconicTraders {
    ...
    private static final Ingredient FOOD_ITEMS = Ingredient.of(
            FlopItems.CUPCAKE.get(), FlopItems.SLAGINIUM.get(), FlopItems.INFUSED_SLAGINIUM.get());
    ...
    protected SoundEvent getEatSound() {
        return FlopSounds.RANVISION_EAT.get();
    }
    ...
    public SoundEvent getAmbientSound() {
        ...
        return switch (randVal) {
            case 1 -> FlopSounds.RANVISION_1.get();
            case 2 -> FlopSounds.RANVISION_2.get();
            case 3 -> FlopSounds.RANVISION_3.get();
            case 4 -> FlopSounds.RANVISION_4.get();
            default -> FlopSounds.RANVISION_5.get();
        };
    }

    @Override
    protected SoundEvent getTradelessSound() {
        return FlopSounds.RANVISION_TRADELESS.get();
    }
    ...
    protected boolean itemIsSpawnEgg(Item pItem) {
        return pItem.equals(FlopItems.RANVISION_SPAWN_EGG.get());
    }
    ...
    public @NotNull SoundEvent getNotifyTradeSound() {
        return this.random.nextBoolean() ? FlopSounds.RANVISION_TRADE_1.get() : FlopSounds.RANVISION_TRADE_2.get();
    }
