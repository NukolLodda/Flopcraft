...
import net.nukollodda.flopcraft.entities.projectiles.Kamaloconut;
import net.nukollodda.flopcraft.sound.FlopSounds;

import java.util.Random;

public class KamalaHarris extends AbstractIconicFigures implements RangedAttackMob {
    ...
    protected @Nullable SoundEvent getHurtSound(DamageSource pDamageSource) {
        ...
        return switch (getRandom().nextInt(3)) {
            case 1 -> FlopSounds.KAMALA_HARRIS_HURT1.get();
            case 2 -> FlopSounds.KAMALA_HARRIS_HURT2.get();
            default -> FlopSounds.KAMALA_HARRIS_HURT3.get();
        };
    }

    @Override
    protected @Nullable SoundEvent getDeathSound() {
        return FlopSounds.KAMALA_HARRIS_DEATH.get();
    }
    ...
    protected @Nullable SoundEvent getAmbientSound() {
        ...
        return switch (getRandom().nextInt(7)) {
            case 1 -> FlopSounds.KAMALA_HARRIS_1.get();
            case 2 -> FlopSounds.KAMALA_HARRIS_2.get();
            case 3 -> FlopSounds.KAMALA_HARRIS_3.get();
            case 4 -> FlopSounds.KAMALA_HARRIS_4.get();
            case 5 -> FlopSounds.KAMALA_HARRIS_5.get();
            case 6 -> FlopSounds.KAMALA_HARRIS_6.get();
            default -> FlopSounds.KAMALA_HARRIS_7.get();
        };
    }
