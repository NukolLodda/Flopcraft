package net.nukollodda.flopcraft.entities.goal;
...
public class FlopcraftBreedingGoal extends Goal {
    ...
    public FlopcraftBreedingGoal(AbstractModEntity entity, double speed) {
        this(entity, speed, entity.getClass());
    }

    public FlopcraftBreedingGoal(AbstractModEntity entity, double speed, Class<? extends AbstractModEntity> pClass) {
        this.entity = entity;
