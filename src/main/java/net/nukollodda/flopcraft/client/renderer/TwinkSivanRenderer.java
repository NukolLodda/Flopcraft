...
public class TwinkSivanRenderer extends MobRenderer<TwinkSivan, PlayerModel<TwinkSivan>> {
    ...
    type.put(TwinkSivan.Variant.RUSH, ResourceLocation.withDefaultNamespace("flopcraft:textures/entities/twink_sivan_1.png"));
    type.put(TwinkSivan.Variant.STARTED, ResourceLocation.withDefaultNamespace("flopcraft:textures/entities/twink_sivan_2.png"));
    type.put(TwinkSivan.Variant.BATH, ResourceLocation.withDefaultNamespace("flopcraft:textures/entities/twink_sivan_3.png"));
    type.put(TwinkSivan.Variant.VEST, ResourceLocation.withDefaultNamespace("flopcraft:textures/entities/twink_sivan_4.png"));
});
