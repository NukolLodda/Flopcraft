...
public class LovelyPeachesBossModel<LovelyPeachesBoss extends Entity> extends EntityModel<LovelyPeachesBoss> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Flopcraft.MODID, "lovely_peaches_boss"), "main");
