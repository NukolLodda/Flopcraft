...
public class MeganTheStallionModel<MeganTheStallion> extends AgeableListModel<net.nukollodda.flopcraft.entities.flops.special.MeganTheStallion> {
    private ModelPart[] saddleParts;
    private ModelPart[] ridingParts;
    private Rectangle body;

    @Override
    public void setupAnim(net.nukollodda.flopcraft.entities.flops.special.MeganTheStallion pEntity, float pLimbSwing,
