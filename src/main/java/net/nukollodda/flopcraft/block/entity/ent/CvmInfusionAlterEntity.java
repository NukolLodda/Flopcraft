...
import net.nukollodda.flopcraft.client.menu.CvmInfusionAlterMenu;
import net.nukollodda.flopcraft.item.FlopItems;
import net.nukollodda.flopcraft.recipes.CvmInfusionAlterRecipe;
import net.nukollodda.flopcraft.recipes.CvmInfusionAlterShapelessRecipe;
...
public class CvmInfusionAlterEntity extends BlockEntity implements MenuProvider {
    private final ItemStackHandler handler = new ItemStackHandler(9) {
        ...
        public boolean isItemValid(int slot, @NotNull ItemStack stack) {
            return switch (slot) {
                case 0 -> stack.is(FlopItems.CVM.get()) || stack.is(ModItems.CVMIUM.get());
                case 8 -> false;
                default -> true;
            };
        }
    ...
    */
    ...
    public CvmInfusionAlterEntity(BlockPos pos, BlockState state) {
        super(FlopBlockEntities.CVM_INFUSION_ALTER.get(), pos, state);
