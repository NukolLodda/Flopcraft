...
public class FlopFluidTypes {
     public static final DeferredRegister<FluidType> FLUID_TYPES =
             DeferredRegister.create(ForgeRegistries.Keys.FLUID_TYPES, Flopcraft.MODID);
     ...
     private static RegistryObject<FluidType> register(String pName, FluidType.Properties pProperties, int pColor) {
         return FLUID_TYPES.register(pName, () -> new FlopFluidType(pColor, pProperties));
     }
