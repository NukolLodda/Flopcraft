...
public class JiafeiArmor extends ArmorItem implements IJiafeiProducts {
    public JiafeiArmor(Type slot) {
        super(new ArmorMaterial() {
            ...
            public Ingredient getRepairIngredient() {
                return Ingredient.of(FlopItems.JIAFEI_PRODUCT.get());
            }
    ...
    public void inventoryTick(ItemStack pStack, Level pLevel, Entity pEntity, int pSlotId, boolean pIsSelected) {
        if (pEntity instanceof LivingEntity living && pSlotId > 36 && pSlotId < 41) {
            living.addEffect(new MobEffectInstance(FlopEffects.YASSIFIED.get(), 5, 1,true, false));
        }
    }
    ...
    public static class Helmet extends JiafeiArmor {
        ...
        public String getArmorTexture(ItemStack stack, Entity ent, EquipmentSlot slot, String type) {
            return "flopcraft:textures/models/armor/jiafei_layer1.png";
        }
    ...
    public static class Leggings extends JiafeiArmor {
        ...
        @Override
        public String getArmorTexture(ItemStack stack, Entity ent, EquipmentSlot slot, String type) {
            return "flopcraft:textures/models/armor/jiafei_layer2.png";
        }
