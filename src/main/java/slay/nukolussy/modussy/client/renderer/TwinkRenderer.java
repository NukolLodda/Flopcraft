...
public class TwinkRenderer extends MobRenderer<Twink, HumanoidModel<Twink>> {
    private static final Map<Variant, ResourceLocation> LOCATION_BY_VARIANT = Util.make(Maps.newEnumMap(Variant.class), (p_114874_) -> {
        p_114874_.put(Variant.FEM, new ResourceLocation("modussy:textures/entities/twink.png"));
        p_114874_.put(Variant.SUIT, new ResourceLocation("modussy:textures/entities/twink_1.png"));
        p_114874_.put(Variant.FLOWER, new ResourceLocation("modussy:textures/entities/twink_2.png"));
        p_114874_.put(Variant.FLANNEL, new ResourceLocation("modussy:textures/entities/twink_3.png"));
        p_114874_.put(Variant.RAINBOW, new ResourceLocation("modussy:textures/entities/twink_4.png"));
        p_114874_.put(Variant.GREEN, new ResourceLocation("modussy:textures/entities/twink_5.png"));
    });
