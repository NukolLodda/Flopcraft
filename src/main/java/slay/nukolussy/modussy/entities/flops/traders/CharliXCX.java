...
public class CharliXCX extends AbstractFlopTraders {
    ...
    private static final Ingredient FOOD_ITEMS = Ingredient.of(ModTags.Items.BRAT);
    ...
    protected SoundEvent getHurtSound(DamageSource pDamageSource) {
        return ModSounds.CHARLI_XCX_HURT.get();
    }

    @Nullable
    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.CHARLI_XCX_DEATH.get();
    }
    ...
    protected SoundEvent getAmbientSound() {
        return switch (getRandom().nextInt(3)) {
            case 1 -> ModSounds.CHARLI_XCX_1.get();
            case 2 -> ModSounds.CHARLI_XCX_2.get();
            default -> ModSounds.CHARLI_XCX_3.get();
        };
    }

    @Override
    protected boolean itemIsSpawnEgg(Item pItem) {
        return pItem.equals(ModItems.CHARLI_XCX_SPAWN_EGG.get());
    }
    ...
    public SoundEvent getNotifyTradeSound() {
        return ModSounds.CHARLI_XCX_3.get();
    }
