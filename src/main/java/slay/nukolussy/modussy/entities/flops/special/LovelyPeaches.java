...
public class LovelyPeaches extends AbstractSpecialFlops implements RangedAttackMob {
    ...
    public void performRangedAttack(LivingEntity pTarget, float pVelocity) {
        // throws a lovely peach that explodes on impact in the direction of her target
    }
