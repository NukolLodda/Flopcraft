...
public class ModFluidTypes {
     ...
     public static final RegistryObject<FluidType> CVM_FLUID = register("cvm_fluid",
             FluidType.Properties.create().temperature(315).viscosity(6900).density(1000), 0xAAAAAA);

     public static final RegistryObject<FluidType> POOSAY_JUICE = register("poosay_juice",
             FluidType.Properties.create().temperature(315).viscosity(710).density(1000), 0x9C6C43);
