...
public class RemixPresent extends Item {
    ...
    private Item randomGiftItem() {
        ...
        return switch (val) {
            ...
            case 12 -> ModItems.DISC_CPM1.get();
            case 13 -> ModItems.DISC_DB1.get();
            case 14 -> ModItems.DISC_J1.get();
            case 15 -> ModItems.DISC_J3.get();
            case 16 -> ModItems.DISC_J5.get();
            case 17 -> ModItems.DISC_JC1.get();
            case 18 -> ModItems.DISC_JC3.get();
