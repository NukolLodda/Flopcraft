...
public class RemixPresent extends Item {
    ...
    private Item randomGiftItem() {
        ...
        return switch (val) {
            ...
            case 13 -> ModItems.DISC_C29.get();
            case 14 -> ModItems.DISC_CPM1.get();
            case 15 -> ModItems.DISC_DB1.get();
            case 16 -> ModItems.DISC_J1.get();
            case 17 -> ModItems.DISC_J3.get();
            case 18 -> ModItems.DISC_J5.get();
            case 19 -> ModItems.DISC_JC1.get();
            case 20 -> ModItems.DISC_JC3.get();
            case 21 -> ModItems.DISC_PM1.get();
            case 22 -> ModItems.DISC_J6.get();
