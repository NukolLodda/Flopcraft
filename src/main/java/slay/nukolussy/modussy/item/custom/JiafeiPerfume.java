...
import slay.nukolussy.modussy.procedures.JiafeiPerfumeSprayed;
...
public class JiafeiPerfume extends Item implements Vanishable {
    public JiafeiPerfume() {
        super(new Item.Properties().tab(ModCreativeTabs.CVMSUMABLES).durability(20));
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
        ...
        JiafeiPerfumeSprayed.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getMainHandItem());
